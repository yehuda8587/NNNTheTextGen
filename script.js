        ...
        <div class="option">
            ...
            <div class="option">
                ...
                <div class="option">
                  ...
                  <div class="option">
                    <input type="radio" class="radio" id="SkinTechSpaBodySculpting" name="SkinTechSpaBodySculpting">
                    <label value="Skin Tech Spa Body Sculpting" for="SkinTechSpaBodySculpting">Skin Tech Spa Body Sculpting</label>
                    </div>

                    <div class="option">
                        <input type="radio" class="radio" id="SkinTechSpaCollagenEnhancing" name="SkinTechSpaCollagenEnhancing">
                        <label value="Skin Tech Spa Collagen Enhancing" for="SkinTechSpaCollagenEnhancing">Skin Tech Spa Collagen Enhancing</label>
                        </div>
